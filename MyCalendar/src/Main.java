...
import src.evenement.RdvPersonnel;
import src.evenement.Reunion;
			...
			while (continuer && utilisateur != null) {
				...
				switch (choix) {
					...
					case "2":
						...
						calendar.ajouterEvent(new RdvPersonnel(new Titre(titre), new Personne(utilisateur),
								new Periode(LocalDateTime.of(annee, moisRdv, jourRdv, heure, minute), duree)));
					...
					case "3":
						...
						participants.ajouterParticipant(new Personne(utilisateur));
						...
						calendar.ajouterEvent(new Reunion(new Titre(titre2), new Personne(utilisateur),
								new Periode(LocalDateTime.of(annee2, moisRdv2, jourRdv2, heure2, minute2), duree2),
					...
					case "4":
						...
						calendar.ajouterEvent(new Periodique(new Titre(titre3), new Personne(utilisateur),
								new Periode(LocalDateTime.of(annee3, moisRdv3, jourRdv3, heure3, minute3), 0), new Frequence(frequence)));
